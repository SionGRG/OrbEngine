...
namespace ORB {
	...
	void OpenGLFramebuffer::Invalidate()
	{
		...
		{
			ORBE_CORE_ASSERT(m_ColorAttachments.size() <= 4, "We only support a maximum of 4 Color attachments!");
		...
		ORBE_CORE_ASSERT(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Framebuffer is incomplete!");
