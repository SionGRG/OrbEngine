...
namespace ORB {
	...
	void ScriptEngine::InitMono()
	{
		...
		//char friendlyName = 'OrbScriptRuntime';
		//char friendlyName = 'OSR';
		s_Data->AppDomain = mono_domain_create_appdomain(const_cast<char*>("OrbScriptRuntime"), nullptr);
		mono_domain_set(s_Data->AppDomain, true);

		//TODO: move this maybe
		s_Data->CoreAssembly = LoadCSharpAssembly("Resources/Scripts/OrbScriptCore.dll");
		PrintAssemblyTypes(s_Data->CoreAssembly);

		MonoImage* assemblyImage = mono_assembly_get_image(s_Data->CoreAssembly);
		MonoClass* monoClass = mono_class_from_name(assemblyImage, "ORB", "Main");
		...
		mono_runtime_invoke(printMessageFunc, instance, &stringParam, nullptr);
