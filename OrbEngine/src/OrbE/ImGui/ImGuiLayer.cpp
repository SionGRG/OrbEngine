...
namespace ORB {
	...
	void ImGuiLayer::OnAttach()
	{
		...
		// TEMPORARY: should eventually use the Orb Engine Key codes
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
        ...
        dispatcher.Dispatch<MouseButtonPressedEvent>(ORBE_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonPressedEvent));
        dispatcher.Dispatch<MouseButtonReleasedEvent>(ORBE_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonReleasedEvent));
        dispatcher.Dispatch<MouseMovedEvent>(ORBE_BIND_EVENT_FN(ImGuiLayer::OnMouseMovedEvent));
        dispatcher.Dispatch<MouseScrolledEvent>(ORBE_BIND_EVENT_FN(ImGuiLayer::OnMouseScrolledEvent));
        dispatcher.Dispatch<KeyPressedEvent>(ORBE_BIND_EVENT_FN(ImGuiLayer::OnKeyPressedEvent));
        dispatcher.Dispatch<KeyReleasedEvent>(ORBE_BIND_EVENT_FN(ImGuiLayer::OnKeyReleasedEvent));
        dispatcher.Dispatch<KeyTypedEvent>(ORBE_BIND_EVENT_FN(ImGuiLayer::OnKeyTypedPressedEvent));
        dispatcher.Dispatch<WindowResizeEvent>(ORBE_BIND_EVENT_FN(ImGuiLayer::OnWindowResizeEvent));
	}
    ...
    bool ImGuiLayer::OnKeyTypedPressedEvent(KeyTypedEvent& e)
    {
        ImGuiIO& io = ImGui::GetIO();
