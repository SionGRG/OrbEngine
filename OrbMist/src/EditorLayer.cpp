...
namespace ORB {
	...
	void EditorLayer::OnUpdate(ORB::Timestep ts)
	{
		ORBE_PROFILE_FUNCTION();
	...
	void EditorLayer::OnImGuiRender()
	{
		...
		/*
		if (m_ViewportSize != *((v2*)&viewportPanelSize) && viewportPanelSize.x > 0 && viewportPanelSize.y > 0)
		{
	...
	void EditorLayer::OnEvent(ORB::Event& e)
	{
